        ...
        return (
            <div>
                ...
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-6 col-md-12 col-sm-12 aboutpagecontent" style={{textAlign: 'justify'}}>
                            <div className="wow backInUp"data-wow-iteration="1"style={{padding:'0px 5px 0px 5px'}}>
                                <div className=" page-header" >Who <span className="homeheader-span">we are</span> </div>
                                <p data-aos="zoom-in-right">We, the <span className="">Kindom of christ church</span> under the divine leadership of our Lord and Saviour, Jesus Christ and direction
                                ...
                                <p data-aos="zoom-in-left">The General Overseer,in person of<span style={{fontSize:'20px', color:'#000'}}> Prophet Immanuel Godfrey</span> is a man of God. God has called him and put the vision of the church in his hands.</p>
                            </div>
                        </div>
                ...
                <div className="statementoffaith container-fluid wow fadeInUp "data-wow-iteration="1" data-wow-offset="80" data-wow-delay=".5s"  style={{background:'rgb(224, 222, 222)'}}>
                    <div className="container" style={{paddingBottom:'40px'}}>
                        ...
                        <p data-aos="fade-right" style={{paddingBottom:'25px', textAlign:'justify'}}>The Bible is God’s unique revelation to people. It is the inspired, infallible Word of God, and the 
                        ...
                        <p data-aos="fade-left" style={{paddingBottom:'25px', textAlign:'justify'}}>  All people are created in God’s image and matter deeply to Him. Central to the message of the Bible is that God loves people, 
                        ...
                        <p data-aos="fade-right" style={{paddingBottom:'25px', textAlign:'justify'}}>
                        ...
                        <p data-aos="fade-left" style={{paddingBottom:'25px', textAlign:'justify'}}>
                ...
                <div className="history container-fluid">
                    <div className="container">
                        ...
                        <p className="historyp" data-aos="flip-left" style={{paddingBottom:'25px'}}>
